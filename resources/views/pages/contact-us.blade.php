...
@section('content')
    <div>
        ...
        <div class="h-full">
            <div class="grid grid-cols-1 lg:grid-cols-2 poppins-regular">
                <div class="relative bg-[#f2f2f2]">
                    <div class="flex items-center justify-center h-full p-[2rem] lg:p-[5rem]" data-aos="zoom-in">
                        <div class="space-y-16">
                            <div class="flex flex-col gap-5">
                                <div class="text-sm font-bold uppercase lg:text-lg">
                                    Get in touch
                                </div>
                                <div class="magistral text-2xl lg:text-5xl xl:w-full 2xl:w-[70%] text-[#f37021]">
                                    Reach Out for Any Questions or Inquiries
                                </div>
                            </div>
                            <div class="flex flex-col gap-5 text-base lg:text-2xl">
                    ...
                    <div class="inset-0 w-full h-full lg:absolute">
