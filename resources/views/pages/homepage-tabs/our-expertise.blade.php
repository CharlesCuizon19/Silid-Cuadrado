<div class="mx-3 2xl:mx-0">
    <div class="container grid grid-cols-1 gap-12 py-24 mx-auto 2xl:grid-cols-2">
        <div class="grid grid-cols-2 gap-4 2xl:gap-7" data-aos="fade-right">
            ...
            <div class="col-span-2">
                <img src="{{ asset('images/expertise-img2.png') }}" alt="" class="w-full h-auto">
            </div>
            <div class="col-span-1">
                <img src="{{ asset('images/expertise-img3.png') }}" alt="" class="w-full h-auto">
            </div>
            <div class="col-span-1">
        ...
        <div class="flex flex-col gap-3 2xl:justify-between 2xl:gap-0" data-aos="fade-left">
            ...
            <div class="text-sm leading-relaxed 2xl:text-xl poppins-regular">
                ...
                to
                electrical works and interior fit-outs. We ensure every project is delivered with precision, efficiency,
                and
