                        ...
                        <div class="swiper-wrapper">
                            @foreach ($product->images as $item)
                                <div class="swiper-slide">
                                    <img src="{{ asset($item) }}" class="w-full h-[400px] object-contain" />
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="swiper-wrapper">
                            @foreach ($product->images as $item)
                                <div class="cursor-pointer swiper-slide">
                                    <img src="{{ asset($item) }}" class="object-cover w-full h-24 " />
                                </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div x-data="{ tab: 'overview' }" class="w-full poppins-regular">
                    ...
                    <div class="mt-4 leading-relaxed">
                        ...
                        <div x-show="tab === 'info'" x-transition>
                            <p>Additional details about specifications, installation, and maintenance can go here.</p>
                        </div>
                    </div>
                </div>
            </div>
