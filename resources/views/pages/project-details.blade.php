...
<div class="bg-[#f2f2f2]">
    <x-banner
        ...
        breadcrumb2="{!! $project->project_title !!}"
        img="images/project-banner.png" />
        ...
        <div class="grid grid-cols-3 gap-16 poppins-regular">
            <div class="flex flex-col col-span-2 gap-6">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    @php
                    // Convert array to string for checking if necessary
                ...
                <div class="flex flex-col gap-5">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center justify-between h-full gap-3 mx-5">
                            <div class="service-gallery-button-prev rounded-full bg-[#515151] hover:bg-[#f37021] p-2 text-white cursor-pointer">
                            ...
                            <div class="service-gallery-button-next rounded-full bg-[#515151] hover:bg-[#f37021] p-2 text-white cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="size-8">
                    ...
                    <div class="w-full swiper myGallerySwiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset($img->images) }}" alt="" class="object-cover w-full h-[20rem] transition duration-300 shadow-md" />
                            </div>
                            @endforeach
                        </div>
                    </div>
                        ...
                        <a href="{{ route('projects.details', $item->id) }}"
                            ...
                            <div class="flex items-center gap-3 ">
                                <div class="w-[70px] h-full overflow-hidden">
                                    <img src="{{ asset($item->project_image) }}" alt="" class="object-cover w-auto h-full">
                                </div>
                                <div class="text-black flex flex-col magistral-medium group-hover:text-[#f37021] transition duration-300">
                    ...
                    <div class="relative z-10 h-full overflow-hidden">
                        <div class="absolute z-20">
                            <div class="flex flex-col gap-5 px-7 py-9 bg-[#f37021] h-full">
                                ...
                                <div class="pt-8">
                                    <x-button border="border-black" link="homepage" text="Contact Us" textcolor="white" />
                                </div>
