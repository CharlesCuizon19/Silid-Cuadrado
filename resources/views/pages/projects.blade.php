        ...
        <div class="container mx-auto">
            <div class="flex flex-col gap-3 poppins-regular">
                ...
                <div class="grid grid-cols-2 gap-5 mt-10" data-aos="zoom-in">
                    ...
                    <a href="{{ route('projects.details', ['id' => $item->id]) }}" class="w-full h-[410px] group overflow-hidden block">
                        <div class="relative">
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                            <div class="absolute bottom-10 left-10 opacity-0 group-hover:opacity-100 transition-all duration-500">
