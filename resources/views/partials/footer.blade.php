                                    ...
                                    <div class="flex gap-8">
                                        <div>
                                            <div
                                                ...
                                                <a href="#"
                                                    class="relative z-10 flex items-center justify-center py-1 overflow-hidden font-medium text-black transition duration-300 w-fit group">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                        class="text-[#f37021] size-10">
                                                        <path fill="currentColor"
                                                            d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95" />
                                                    </svg>
                                                </a>
                                                <div
                                                    class="absolute w-fit h-6 px-[30px] border-gray-400 border-t border-l border-r group-hover:border-r-2 group-hover:border-l-2 group-hover:border-t-2 -top-1">
                                                </div>
                                                <div
                                                    class="absolute w-fit h-6 px-[30px] border-gray-400 border-b border-l border-r -bottom-1 group-hover:border-b-2 group-hover:border-l-2 group-hover:border-r-2">
                                                </div>
                                            </div>
                                        </div>
                                        <div>
